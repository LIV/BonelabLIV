...
namespace LIV.SDK.Unity
{
    ...
    {        
        ...
        public static RenderTextureReadWrite GetReadWriteFromColorSpace(TextureColorSpace colorSpace)
        {
            switch (colorSpace)
            {
        ...
        public static TextureColorSpace GetDefaultColorSpace {
            get {
                ...
                return TextureColorSpace.Undefined;
            }
        }

        public static TextureColorSpace GetColorSpace(RenderTexture renderTexture)
        {
            if (renderTexture == null) return TextureColorSpace.Undefined;
            if (renderTexture.sRGB) return TextureColorSpace.Srgb;
            return TextureColorSpace.Linear;
        }

        public static RenderingPipeline GetRenderingPipeline(RenderingPath renderingPath)
        {
            switch (renderingPath)
            {
                case RenderingPath.DeferredLighting:
                    return RenderingPipeline.Deferred;
                case RenderingPath.DeferredShading:
                    return RenderingPipeline.Deferred;
                case RenderingPath.Forward:
                    return RenderingPipeline.Forward;
                case RenderingPath.VertexLit:
                    return RenderingPipeline.VertexLit;
                default:
                    return RenderingPipeline.Undefined;
            }
        }

        public static TextureDevice GetDevice()
        {
            switch (SystemInfo.graphicsDeviceType)
            {
                case UnityEngine.Rendering.GraphicsDeviceType.Direct3D11:
                case UnityEngine.Rendering.GraphicsDeviceType.Direct3D12:
                    return TextureDevice.Directx;
                case UnityEngine.Rendering.GraphicsDeviceType.Vulkan:
                    return TextureDevice.Vulkan;
                case UnityEngine.Rendering.GraphicsDeviceType.Metal:
                    return TextureDevice.Metal;
                case UnityEngine.Rendering.GraphicsDeviceType.OpenGLCore:
                    return TextureDevice.Opengl;
                default:
                    return TextureDevice.Undefined;
            }
        }
        ...
        {
            RenderingPipeline renderingPipeline = RenderingPipeline.Undefined;
